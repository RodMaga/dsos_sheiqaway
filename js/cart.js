        ...
        container.innerHTML = `
            <div style="text-align: center; padding: 50px 20px; animation: fadeIn 0.5s ease-out;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center;">
                    <button onclick="window.location.href='login.html'" class="search-button" style="min-width: 150px;">
                        Fazer Login
                    </button>
                    <button onclick="window.location.href='index.html'" class="secondary-button" style="min-width: 150px;">
                        Procurar Viagens
                    </button>
                </div>
            </div>
        ...
        if (this.cart.length === 0) {
            container.innerHTML = `
                <div style="text-align: center; padding: 50px 20px; animation: fadeIn 0.5s ease-out;">
                    ...
                    <button onclick="window.location.href='index.html'" class="search-button" style="min-width: 200px;">
        ...
        container.innerHTML = `
            <div style="text-align: center; padding: 40px 20px; animation: fadeIn 0.5s ease-out;">
                ...
                <div style="display: flex; gap: 15px; justify-content: center; margin-top: 40px;">
                    <button onclick="window.location.href='perfil.html'" class="search-button" style="min-width: 180px;">
                        Ver Minhas Reservas
                    </button>
                    <button onclick="window.location.href='index.html'" class="secondary-button" style="min-width: 180px;">
                        Nova Viagem
                    </button>
                </div>
            </div>
